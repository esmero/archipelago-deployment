<!--documentation
---
title: "Installing Archipelago (2.1.0) Drupal 11 on OSX (macOS)"
tags:
...
# Installing Archipelago (2.1.0) Drupal 11 on macOS
...
## Step 1 (M1/M2/M3/M4/M5): Docker Deployment on Apple Silicon Chips (M1/M2/M3/M4/M5)
